...
public class GetListObjectService implements IGetListObjectService {
	...
	@Override
	public Mono<ResultBO> getArrayList(String path, RequestContent requestContent) throws IOException {
		return this.requestUtils.getRequest(path, ResultType.ARRAY_TYPE, requestContent);
	}
